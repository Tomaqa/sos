...
Tato modelová úloha slouží pro~ověření
zacházení s~návraty a se~zcela
nedeterministickými přechody mezi diskrétními stavy.
...
alespoň do~úseku \id{t = 5}
(do~té doby je úloha nezajímavá,
protože např. téměř stačí jen setrvat na~$0$).
...
až~po~vyhodnocení našim nástrojem.
...
Tato úloha je také orientována na~čas,
