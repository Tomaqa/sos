...
řešící \acr{ivp} po~předem danou dobu,
...
% Fri 04 May 2018 11:16:19 AM CEST
...
výsledný prototyp řešiče je v~některých
praktických úlohách násobně rychlejší,
než stávající řešič dReal.
Byl navržen a realizován společný vstupní jazyk,
ve~kterém lze vstup parametrizovat pomocí maker,
a není problém např. vytvořit kaskádní kompozici systémů.
...
% Výhled
Prototyp zatím obsahuje řadu nedostatků a zjednodušení.
