...
% Fri 04 May 2018 11:40:02 AM CEST
\abstractCS{
% Úvod
...
jedním z~používaných způsobů je např. \acr{sat}.
...
Propojení \acr{smt} a \acr{ode} řešiče
je flexibilní, jelikož jsou oba
nezávislé od~ostatních komponent.
Použit byl řešič odeint,
a z~\acr{smt} řešičů to byly \acr{cvc}4 a z3.

% Výsledky, užitek
Hlavním výstupem
je potvrzení zvoleného konceptu,
který používá klasické numerické metody
pro~řešení \acr{ode}:
pro~některé praktické úlohy
je verifikace modelu naším způsobem několikanásobně
rychlejší než v~případě řešiče dReal,
aniž by byl znatelný rozdíl
v~přesnosti výstupů.
...
% Fri 04 May 2018 06:15:12 PM CEST
...
nevím zda je to přepsáno správně. .. OK}
...
% Sat 05 May 2018 01:14:37 PM CEST
\begin{subsection}{Měřící platforma}\label{ss:exp:method:platform}
...
standardu \acr{omp}.
\end{subsection} %%Měřící platforma
...
neboť prozdradí některá první zjištění,
...
% Sun 06 May 2018 12:26:24 AM CEST
\begin{subsection}{Elektrický oscilátor}\label{ss:exp:examples:osc}
...
je aproximován s~krokem \id{0.25}.
...
% Sat 05 May 2018 01:57:37 PM CEST
\begin{section}{Další možné aplikace}\label{s:exp:next}
\end{section} %%Další možné aplikace
...
% Fri 04 May 2018 06:29:54 PM CEST
