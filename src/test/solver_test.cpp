...
namespace SOS {
    namespace Test {
        ...
        using Solve_odes_params = tuple<Time, bool>;
                           ...
                           Solve_odes_params& params)
        {
            ...
            Time step_size = get<0>(params);
            bool unify = get<1>(params);
            Solver solver(osspec, keyss, unify);
            if (step_size > 0) solver.set_step_size(step_size);
...
try {
    ...
    Test_data<Solve_odes_params, Solve_odes_output, Solve_odes_input> solve_odes_euler_data = {
        {  { { {{"- 1"}}, {{"+ 1"}} }, {{"x"}, {"y"}}, { {{0, 10}, {100}}, {{50, 70}, {20}} }  },                                                        {-1,   false},       {{90, 40}}                                      },
        {  { { {{"- 1"}}, {{"+ 1"}} }, {{"x"}, {"y"}}, { {{0, 10}, {100}}, {{0, 10}, {20}} }  },                                                         {-1,   false},       {{90, 30}}                                      },
        {  { { {{"- 1"}}, {{"+ 1"}} }, {{"x"}, {"y"}}, { {{0, 10}, {100}}, {{0, 10}, {20}} }  },                                                         {-1,   true },       {{90, 30}}                                      },
        {  { { {{"- 1"}}, {{"+ 1"}} }, {{"x", "y"}, {"x", "y"}}, { {{0, 10}, {100, 20}}, {{0, 10}, {100, 20}} }  },                                      {-1,   false},       {{90, 30}}                                      },
        {  { { {{"- 1"}}, {{"+ 1"}} }, {{"x", "y"}, {"x", "y"}}, { {{0, 10}, {100, 20}}, {{0, 10}, {100, 20}} }  },                                      {-1,   true },       {{90, 30}}                                      },
        {  { { {{"- 1"}}, {{"+ 1"}} }, {{"x", "y"}, {"y", "x"}}, { {{0, 10}, {100, 20}}, {{0, 10}, {20, 100}} }  },                                      {-1,   true },       {{90, 30}}                                      },
        {  { { {{"- 1"}}, {{"+ 1"}} }, {{"x"}, {"y"}}, { {{0, 10}, {100, 20}} }  },                                                                      {-1,   true },       {{90, 30}}                                      },
        {  { { {{"+ x ( - 10 y)"}, {"+ x y"}}, {{"+ 1"}, {"- 1"}} }, {{"x", "y"}, {"y", "x"}}, {{{0, 50}, {5, 20}}, {{0, 50}, {5, 20}}} },               {0.05, false},     {{-7.73159e21, 55}, {3.8658e22, -45}}           },
        {  { { {{"+ x ( - 10 20)"}, {"+ x 20"}}, {{"+ 1"}, {"- 1"}} }, {{"x", "y"}, {"x", "y"}}, {{{0, 50}, {5, 20}}, {{0, 50}, {5, 20}}} },             {0.05, false},     {{-7.73159e21, 70}, {3.8658e22, -30}}           },
        {  { { {{"- (/ t 3) x"}, {"- (/ x 2) (/ t 3)"}}, {{"+ 1"}, {"+ 1"}} }, {{"x"}, {"tt", "x"}}, {{{0, 50}, {10}}, {{0, 50}, {0, 30}}} },            {0.02, false},     {{16.34, 50}, {5.5e11, 50}}                     },
        {  { { {{"- (/ t 3) x"}, {"- (/ x 2) (/ tt 3)"}}, {{"+ 1"}, {"+ 1"}} }, {{"x", "tt"}, {"tt", "x"}}, {{{0, 50}, {10, 0}}, {{0, 50}, {0, 30}}} },  {0.02, false},     {{16.34, 50}, {6.35967e11, 50}}        },
        {  { { {{"- (* 2 x) 100"}}, {{"+ y ( - 10 z)"}} }, {{"x"}, {"y", "z"}}, {{{0, 10}, {100}}, {{0, 50}, {5, 20}}} },                                {0.05, false},     {{9.49526e9, -7.73159e21}}                      },
        {  { { {{"- (* 2 x) 100"}}, {{"+ y ( - 10 z)"}} }, {{"x", "z"}, {"y", "z", "x"}}, {{{0, 10}, {100, 20}}, {{0, 50}, {5, 20, 100}}} },             {0.05, false},     {{9.49526e9, -7.73159e21}}                      },
    };
    Test_data<Solve_odes_params, Solve_odes_output, Solve_odes_input> solve_odes_odeint_data = {
        {  { { {{"- 1"}}, {{"+ 1"}} }, {{"x"}, {"y"}}, { {{0, 10}, {100}}, {{50, 70}, {20}} }  },                                                        {-1,   false},       {{90, 40}}                                      },
        {  { { {{"- 1"}}, {{"+ 1"}} }, {{"x"}, {"y"}}, { {{0, 10}, {100}}, {{0, 10}, {20}} }  },                                                         {-1,   false},       {{90, 30}}                                      },
        {  { { {{"+ x ( - 10 y)"}, {"+ x y"}}, {{"+ 1"}, {"- 1"}} }, {{"x", "y"}, {"y", "x"}}, {{{0, 50}, {5, 20}}, {{0, 50}, {5, 20}}} },               {0.05, false},     {{-2.59242e22, 55}, {1.29621e23, -45}}          },
        {  { { {{"+ x ( - 10 20)"}, {"+ x 20"}}, {{"+ 1"}, {"- 1"}} }, {{"x", "y"}, {"x", "y"}}, {{{0, 50}, {5, 20}}, {{0, 50}, {5, 20}}} },             {0.05, false},     {{-2.59242e22, 70}, {1.29621e23, -30}}          },
        {  { { {{"- (/ t 3) x"}, {"- (/ x 2) (/ t 3)"}}, {{"+ 1"}, {"+ 1"}} }, {{"x"}, {"tt", "x"}}, {{{0, 50}, {10}}, {{0, 50}, {0, 30}}} },            {0.02, false},     {{16.3267, 50}, {6.24e11, 50}}                  },
        {  { { {{"- (/ t 3) x"}, {"- (/ x 2) (/ tt 3)"}}, {{"+ 1"}, {"+ 1"}} }, {{"x", "tt"}, {"tt", "x"}}, {{{0, 50}, {10, 0}}, {{0, 50}, {0, 30}}} },  {0.02, false},     {{16.3267, 50}, {7.2e11, 50}}          },
        {  { { {{"- (* 2 x) 100"}}, {{"+ y ( - 10 z)"}} }, {{"x"}, {"y", "z"}}, {{{0, 10}, {100}}, {{0, 50}, {5, 20}}} },                                {0.05, false},     {{2.425e10, -2.59242e22}}                       },
        {  { { {{"- (* 2 x) 100"}}, {{"+ y ( - 10 z)"}} }, {{"x", "z"}, {"y", "z", "x"}}, {{{0, 10}, {100, 20}}, {{0, 50}, {5, 20, 100}}} },             {0.05, false},     {{2.425e10, -2.59242e22}}                       },
    };
    ...
    Test_data<Dummy, State, string> solve_euler_data = {
        ...
        {  "( (( * ( - r ) gam )) (( + 0 ) ( - om ) ( + om )) )*( (p gam om r t) (gam om r t) ) \n (0 2) (( (0.0 1.0) (0.0 1.0 2.0 5.0) ) ( (0.0 1.0) (1.0 2.0 5.0) ))", {}, {-9.95, 3.0}   },
