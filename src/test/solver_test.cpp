...
try {
    ...
    Test_data<Solve_unif_odes_params, Solve_unif_odes_output, Solve_unif_odes_input> solve_unif_odes_euler_data = {
        ...
        {  { { {{"- (/ tt 3) x"}, {"- (/ x 2) (/ tt 3)"}}, {{"+ 1"}, {"+ 1"}} }, {"x", "tt"}, {{0, 50}, {10, 0}} },                             {0.02},     {{16.3333, 50}, {5.5117124e11, 50}}               },
    ...
    Test_data<Solve_odes_params, Solve_odes_output, Solve_odes_input> solve_odes_euler_data = {
        ...
        {  { { {{"- (/ t 3) x"}, {"- (/ x 2) (/ t 3)"}}, {{"+ 1"}, {"+ 1"}} }, {{"x"}, {"tt", "x"}}, {{{0, 50}, {10}}, {{0, 50}, {0, 30}}} },   {0.02},     {{16.3333, 50}, {5.5117124e11, 50}}             },
        {  { { {{"- (/ t 3) x"}, {"- (/ x 2) (/ tt 3)"}}, {{"+ 1"}, {"+ 1"}} }, {{"x", "tt"}, {"tt", "x"}}, {{{0, 50}, {10, 0}}, {{0, 50}, {0, 30}}} },  {0.02},     {{16.3333, 50}, {6.35967e11, 50}}      },
    ...
    Test_data<Dummy, State, string> solve_euler_data = {
        ...
        // {  "( (( * ( - r ) ( sin gam ) )) (( + 0 ) ( - om ) ( + om )) )( (p gam om r t) ) \n (0 0) (( (0.0 1.0) (0.0 3.14159265 2.0 5.0) ))",    {},       {-0.0, 3.14159265}             },
