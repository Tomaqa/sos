...
( assert ( and ( = t_1 ( + t_0 0.35 ) ) ( = t_2 ( + t_1 0.35 ) ) ( = t_3 ( + t_2 0.35 ) ) ( = t_4 ( + t_3 0.35 ) ) ( = t_5 ( + t_4 0.35 ) ) ( = t_6 ( + t_5 0.35 ) ) ( = t_7 ( + t_6 0.35 ) ) ( = t_8 ( + t_7 0.35 ) ) ( = t_9 ( + t_8 0.35 ) ) ) )
...
( assert ( and ( = c_1_1 ( int-ode_c 0 ) ) ( = c_1_2 ( int-ode_c 1 ) ) ( = c_1_3 ( int-ode_c 2 ) ) ( = c_1_4 ( int-ode_c 3 ) ) ( = c_1_5 ( int-ode_c 4 ) ) ( = c_1_6 ( int-ode_c 5 ) ) ( = c_1_7 ( int-ode_c 6 ) ) ( = c_1_8 ( int-ode_c 7 ) ) ( = c_1_9 ( int-ode_c 8 ) ) ) )
