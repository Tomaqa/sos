...
( assert ( and ( > p_hi p_lo ) ( < p_min p_lo ) ( >= p0 p_lo ) ( <= p0 p_hi ) ( >= gam0 ( - ( / pi 4 ) ) ) ( <= gam0 ( / pi 4 ) ) ) )
...
( declare-fun dc_8 ( ) Dt )
( declare-fun dc_9 ( ) Dt )
( assert ( and ( = t_0 t0 ) ( = p_0 p0 ) ( = gam_0 gam0 ) ( = c_0_1 c_0_2 c0 ) ( = correct_0 correct0 ) ( = left_0 left0 ) ( = ahead_0 ahead0 ) ( = canal_0 canal0 ) ) )
...
( assert ( and ( = p_1 ( int-ode_p 0 ) ) ( = p_2 ( int-ode_p 1 ) ) ( = p_3 ( int-ode_p 2 ) ) ( = p_4 ( int-ode_p 3 ) ) ( = p_5 ( int-ode_p 4 ) ) ( = p_6 ( int-ode_p 5 ) ) ( = p_7 ( int-ode_p 6 ) ) ( = p_8 ( int-ode_p 7 ) ) ( = p_9 ( int-ode_p 8 ) ) ) )
( assert ( and ( = gam_1 ( int-ode_gam 0 ) ) ( = gam_2 ( int-ode_gam 1 ) ) ( = gam_3 ( int-ode_gam 2 ) ) ( = gam_4 ( int-ode_gam 3 ) ) ( = gam_5 ( int-ode_gam 4 ) ) ( = gam_6 ( int-ode_gam 5 ) ) ( = gam_7 ( int-ode_gam 6 ) ) ( = gam_8 ( int-ode_gam 7 ) ) ( = gam_9 ( int-ode_gam 8 ) ) ) )
( assert ( and ( = c_1_1 ( int-ode_c 0 ) ) ( = c_2_1 ( int-ode_c 1 ) ) ( = c_3_1 ( int-ode_c 2 ) ) ( = c_4_1 ( int-ode_c 3 ) ) ( = c_5_1 ( int-ode_c 4 ) ) ( = c_6_1 ( int-ode_c 5 ) ) ( = c_7_1 ( int-ode_c 6 ) ) ( = c_8_1 ( int-ode_c 7 ) ) ( = c_9_1 ( int-ode_c 8 ) ) ) )
...
( assert ( and ( jump correct_0 correct_1 left_0 left_1 ahead_0 ahead_1 canal_0 canal_1 p_1 c_1_1 c_1_2 ) ( jump correct_1 correct_2 left_1 left_2 ahead_1 ahead_2 canal_1 canal_2 p_2 c_2_1 c_2_2 ) ( jump correct_2 correct_3 left_2 left_3 ahead_2 ahead_3 canal_2 canal_3 p_3 c_3_1 c_3_2 ) ( jump correct_3 correct_4 left_3 left_4 ahead_3 ahead_4 canal_3 canal_4 p_4 c_4_1 c_4_2 ) ( jump correct_4 correct_5 left_4 left_5 ahead_4 ahead_5 canal_4 canal_5 p_5 c_5_1 c_5_2 ) ( jump correct_5 correct_6 left_5 left_6 ahead_5 ahead_6 canal_5 canal_6 p_6 c_6_1 c_6_2 ) ( jump correct_6 correct_7 left_6 left_7 ahead_6 ahead_7 canal_6 canal_7 p_7 c_7_1 c_7_2 ) ( jump correct_7 correct_8 left_7 left_8 ahead_7 ahead_8 canal_7 canal_8 p_8 c_8_1 c_8_2 ) ( jump correct_8 correct_9 left_8 left_9 ahead_8 ahead_9 canal_8 canal_9 p_9 c_9_1 c_9_2 ) ) )
