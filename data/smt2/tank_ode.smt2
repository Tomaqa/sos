...
(define-fun eval-dy ((dy1 Real) (t1 Real) (t2 Real) (y1 Real)) Real
(let ((C (ite (= dy1 dy_in) inflow 0.0)))
    (+ y1 (* (- C outflow) (- t2 t1) ))
))

(define-fun eval-dtau ((dtau1 Real) (t1 Real) (t2 Real) (tau1 Real)) Real
(let ((C (ite (= dtau1 dtau_wait) 1.0 0.0)))
    (+ tau1 (* C (- t2 t1) ))
))

;;; Additional assertions

(assert (= (dt-int dy_0  t_0  t_1  y_0)  (eval-dy dy_0  t_0  t_1  y_0)))
(assert (= (dt-int dy_1  t_1  t_2  y_1)  (eval-dy dy_1  t_1  t_2  y_1)))
(assert (= (dt-int dy_2  t_2  t_3  y_2)  (eval-dy dy_2  t_2  t_3  y_2)))
(assert (= (dt-int dy_3  t_3  t_4  y_3)  (eval-dy dy_3  t_3  t_4  y_3)))
(assert (= (dt-int dy_4  t_4  t_5  y_4)  (eval-dy dy_4  t_4  t_5  y_4)))
(assert (= (dt-int dy_5  t_5  t_6  y_5)  (eval-dy dy_5  t_5  t_6  y_5)))
(assert (= (dt-int dy_6  t_6  t_7  y_6)  (eval-dy dy_6  t_6  t_7  y_6)))
(assert (= (dt-int dy_7  t_7  t_8  y_7)  (eval-dy dy_7  t_7  t_8  y_7)))
(assert (= (dt-int dy_8  t_8  t_9  y_8)  (eval-dy dy_8  t_8  t_9  y_8)))
(assert (= (dt-int dy_9  t_9  t_10  y_9) (eval-dy dy_9  t_9  t_10 y_9)))
(assert (= (dt-int dy_10 t_10 t_11 y_10) (eval-dy dy_10 t_10 t_11 y_10)))
(assert (= (dt-int dy_11 t_11 t_12 y_11) (eval-dy dy_11 t_11 t_12 y_11)))
(assert (= (dt-int dy_12 t_12 t_13 y_12) (eval-dy dy_12 t_12 t_13 y_12)))
(assert (= (dt-int dy_13 t_13 t_14 y_13) (eval-dy dy_13 t_13 t_14 y_13)))
(assert (= (dt-int dy_14 t_14 t_15 y_14) (eval-dy dy_14 t_14 t_15 y_14)))
(assert (= (dt-int dy_15 t_15 t_16 y_15) (eval-dy dy_15 t_15 t_16 y_15)))
(assert (= (dt-int dy_16 t_16 t_17 y_16) (eval-dy dy_16 t_16 t_17 y_16)))
(assert (= (dt-int dy_17 t_17 t_18 y_17) (eval-dy dy_17 t_17 t_18 y_17)))
(assert (= (dt-int dy_18 t_18 t_19 y_18) (eval-dy dy_18 t_18 t_19 y_18)))

(assert (= (dt-int dtau_0  t_0  t_1  tau_0_2)  (eval-dtau dtau_0  t_0  t_1  tau_0_2)))
(assert (= (dt-int dtau_1  t_1  t_2  tau_1_2)  (eval-dtau dtau_1  t_1  t_2  tau_1_2)))
(assert (= (dt-int dtau_2  t_2  t_3  tau_2_2)  (eval-dtau dtau_2  t_2  t_3  tau_2_2)))
(assert (= (dt-int dtau_3  t_3  t_4  tau_3_2)  (eval-dtau dtau_3  t_3  t_4  tau_3_2)))
(assert (= (dt-int dtau_4  t_4  t_5  tau_4_2)  (eval-dtau dtau_4  t_4  t_5  tau_4_2)))
(assert (= (dt-int dtau_5  t_5  t_6  tau_5_2)  (eval-dtau dtau_5  t_5  t_6  tau_5_2)))
(assert (= (dt-int dtau_6  t_6  t_7  tau_6_2)  (eval-dtau dtau_6  t_6  t_7  tau_6_2)))
(assert (= (dt-int dtau_7  t_7  t_8  tau_7_2)  (eval-dtau dtau_7  t_7  t_8  tau_7_2)))
(assert (= (dt-int dtau_8  t_8  t_9  tau_8_2)  (eval-dtau dtau_8  t_8  t_9  tau_8_2)))
(assert (= (dt-int dtau_9  t_9  t_10 tau_9_2)  (eval-dtau dtau_9  t_9  t_10 tau_9_2)))
(assert (= (dt-int dtau_10 t_10 t_11 tau_10_2) (eval-dtau dtau_10 t_10 t_11 tau_10_2)))
(assert (= (dt-int dtau_11 t_11 t_12 tau_11_2) (eval-dtau dtau_11 t_11 t_12 tau_11_2)))
(assert (= (dt-int dtau_12 t_12 t_13 tau_12_2) (eval-dtau dtau_12 t_12 t_13 tau_12_2)))
(assert (= (dt-int dtau_13 t_13 t_14 tau_13_2) (eval-dtau dtau_13 t_13 t_14 tau_13_2)))
(assert (= (dt-int dtau_14 t_14 t_15 tau_14_2) (eval-dtau dtau_14 t_14 t_15 tau_14_2)))
(assert (= (dt-int dtau_15 t_15 t_16 tau_15_2) (eval-dtau dtau_15 t_15 t_16 tau_15_2)))
(assert (= (dt-int dtau_16 t_16 t_17 tau_16_2) (eval-dtau dtau_16 t_16 t_17 tau_16_2)))
(assert (= (dt-int dtau_17 t_17 t_18 tau_17_2) (eval-dtau dtau_17 t_17 t_18 tau_17_2)))
(assert (= (dt-int dtau_18 t_18 t_19 tau_18_2) (eval-dtau dtau_18 t_18 t_19 tau_18_2)))
